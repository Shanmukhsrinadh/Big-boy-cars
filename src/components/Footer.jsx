        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="py-8 sm:py-10">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              ...
              <div className="col-span-2 md:col-span-1">
                <div className="flex items-center gap-2 mb-3">
                  <div className="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center overflow-hidden">
                    <img src="/logo.png" alt="AutoPrime logo" className="w-full h-full object-contain" />
                  </div>
                  <h1 className="text-lg font-bold text-white">AutoPrime</h1>
                </div>
              ...
              <address className="not-italic">
                ...
                <div className="space-y-2 text-xs text-slate-400">
                  <a href="tel:+919999999999" className="block hover:text-white">
                    📞 +91 99999 99999
                  </a>
                  <a href="https://wa.me/919999999999" target="_blank" rel="noopener noreferrer" className="block hover:text-green-400">
                    💬 WhatsApp Us
                  </a>
                  <p>
                    📍 AutoPrime Motors,<br />
            ...
            <div className="mt-8 pt-4 border-t border-slate-800 flex flex-col sm:flex-row justify-between gap-2 text-[11px] text-slate-500">
              <p>© {new Date().getFullYear()} AutoPrime Motors Pvt. Ltd.</p>
